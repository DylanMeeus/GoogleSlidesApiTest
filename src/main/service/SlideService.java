...
public class SlideService {
    ...
    private static final List<String> SCOPES =
            Arrays.asList(SlidesScopes.PRESENTATIONS);

    private static final String client_location = "src\\main\\resources\\client_id.json";
     ...
     * @throws IOException
     */
    public static Slides getSlidesService(String applicationName) throws IOException {
