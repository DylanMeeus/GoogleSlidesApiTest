...
public class Quickstart {
    ...
    public static Credential authorize() throws IOException {
        // Load client secrets.
        String client_location = "src\\main\\resources\\client_id.json";
        InputStream in =
                Quickstart.class.getResourceAsStream("src\\main\\resources\\client_id.json");

        Path path = Paths.get(client_location);
